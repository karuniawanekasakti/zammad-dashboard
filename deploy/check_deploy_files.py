...
assert 'location = /index.html' in nginx.read_text()
assert 'Cache-Control "no-store"' in nginx.read_text()
assert 'location /assets/' in nginx.read_text()
assert 'try_files $uri =404;' in nginx.read_text()
